...
export const metadata: Metadata = {
  title: 'SkyBook — Book flights in seconds',
  description: 'Search and book flights with a simple Next.js demo app.',
}
    ...
    >
      <body className="flex min-h-full flex-col bg-zinc-50 text-zinc-900 dark:bg-black dark:text-zinc-50">
        ...
        <footer className="border-t border-zinc-200 py-4 text-center text-xs text-zinc-500 dark:border-zinc-800">
          SkyBook demo · Next.js App Router + cookie-session auth · data stored
          in data/db.json
        </footer>
      </body>
    </html>

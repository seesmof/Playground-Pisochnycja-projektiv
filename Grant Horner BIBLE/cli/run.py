...
with open(get_path('chapters.json')) as f:
    chapters = json.load(f)
with open(get_path('names.json')) as f:
    names = json.load(f)
with open(get_path('abbreviations.json')) as f:
    abbreviations = json.load(f)
with open(get_path('shorts.json')) as f:
    eBible_abbreviations = json.load(f)
with open(get_path('lists.json')) as f:
    lists = json.load(f)
...
def open_chapter(Book_number: int,
                 chapter: int,
...
with open(get_path('lists.json'), 'w') as f:
